...
<head>
	...
	<script src="js/steps_settings.js"></script>
	<style>
	.account2
	{
        ...
        <div class="page-container2">
            ...
            <div class="main-content" style="font-size:15px;">
                <div class="section__content section__content--p30" style="padding:0px;">
                    <div class="container-fluid">
                        <div class="row">
							<h3 style="padding:15px;padding-top:0px;">Settings - Application Steps</h3>
                            <div class="col-lg-12" id="applicant_view_list_div">
							<div class="alert alert-success" id="success-alert" style="display:none;">
							  Data has been Updated successfully...
							</div>
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" id="view_steps_settings">
                                        <thead>
                                            <tr>
