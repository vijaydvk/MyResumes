...
{
	require( TEMPLATE_PATH . "/manager_handoff_page.php" );
}
function marketPage()
{
...
{
	require( TEMPLATE_PATH . "/openingChecklist_views_page.php" );
}

function closingChecklist()
{
	require( TEMPLATE_PATH . "/closingChecklist_views_page.php" );
}

function saveOpeningChecklist() {

	$results = array();
	$results['errorReturnAction'] = "saveOpeningChecklist";
	if ($_REQUEST['mode'] == 'add')
	{
		opening_checklist::add();
	}
	else if ($_REQUEST['mode'] == 'update')
	{
		opening_checklist::update();
	}
}

function saveclosingChecklist() {

	$results = array();
	$results['errorReturnAction'] = "saveclosingChecklist";
	if ($_REQUEST['mode'] == 'add')
	{
		closing_checklist::add();
	}
	else if ($_REQUEST['mode'] == 'update')
	{
		closing_checklist::update();
	}
}
