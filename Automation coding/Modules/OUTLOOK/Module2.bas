...
' MsgBox mailcount
                 ...
                 Set wddoc1 = wdapp1.Workbooks.Open("d:\Book2.xlsx")
                 wdapp1.Visible = True
              ...
              Next i1
             mysheet1.Range("A:G").Sort Key1:=mysheet1.Range("B1:B" & count), Order1:=xlDescending, Orientation:=xlTopToBottom, DataOption1:=xlSortNormal
             If count > 0 Then
