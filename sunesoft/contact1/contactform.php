...
$formproc->AddRecipient('maintenancefreshdesk@yahoo.com'); //<<---Put your email address here
...
$formproc->AddFileUploadField('resume1','doc,docx,pdf,txt',2024);

if(isset($_POST['submitted']))
{
   if($formproc->ProcessForm())
   {
        echo "<script>alert('Mail Sent Successfully');window.location.href = 'http://www.sune-soft.com/contact1/contactform.php';</script>";
   }
}
...
<div class='container'>
    <label for='photo' >Upload your Resume:</label><br/>
    <input type="file" name='resume1' id='resume1' /><br/>
    <span id='contactus_photo_errorloc' class='error'>Upload .doc (or) .pdf Files</span>
</div>
